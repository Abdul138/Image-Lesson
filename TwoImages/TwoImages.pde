//Global Variable
float imageX1, imageY1, imageWidth1, imageHeight1, imageWidthRatio1=0.0, imageHeightRatio1 =0.0, picWidthAdjusted1, picHeightAdjusted1;
...
float imageLargerDimension1, imageSmallerDimension1, imageSmallerDimension2, imageLargerDimension2;
...
void setup() {
  ...
  //
  //Population of Image
  pic1 = loadImage("../Images Used/Soccer.jpg"); //Dimensions: width 6240, height 4160
  pic2 = loadImage("../Images Used/Second-Soccer.jpg"); // Dimensions: width 3365, height 4351
