...
void setup() {
  ...
  //
  //Population of Image
  pic = loadImage("../Images/Soccer.jpg"); //Dimensions: width 800, height 600
  //Note: Dimensions are found in the image file / Right Click / Properties / Details
  //Alogrithm: Find the larger dimension for aspect ration (comparison of two numbers)
  int picWidth = 6240; //Mine is 800, do not copy this!!!
  int picHeight = 4160; //Mine is 600, do not copy this!!!
  //
